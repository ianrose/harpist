#!/usr/bin/env node
var clientInfo = require('./client_id.json');
var CLIENT_ID= clientInfo.web.client_id;
var CLIENT_SECRET= clientInfo.web.client_secret;
...
var oauth2Client = new OAuth2(CLIENT_ID, CLIENT_SECRET, "http://127.0.0.1:8080/oauth2callback");
google.options({ auth: oauth2Client });
var KEY = '1Pcg44oV-mzcMxZXNGoeuB-RthWyhNBxxZzRLR88NaxQ';
...
var server = app.listen(8080, function () {
  ...
  console.log('gDocs app listening at http://%s:%s', host, port);
});
